module.exports = [
  ...
  },
  {
    ...
    topic: 'football',
    author: 'weegembump',
    body: `Jose Mourinho was at The O2 on Sunday night to watch Dominic Thiem in action against Novak Djokovic. Thiem took the first set before Djokovic fought back to claim the victory, but Manchester United's manager was clearly impressed with the Austrian's performance. Mourinho met with Thiem after the match and handed his VIP pass to the 23-year-old. On the back, he signed his name and wrote: "A star is born. Big hug." The message suggested a softer side to a man who has made his name as a combative coach. But what does the handwriting itself say about Mourinho? We asked handwriting expert Tracey Trussell of the British Institute of Graphologists to take a look at the note and tell us what Mourinho's scrawl implies about him as an individual. "Jose Mourinho is a very observant, take-charge sort of man who acts on a hunch, quickly sees the big picture and places great importance on applying the small detail," Ms Trussell told NC News.`,
    created_at: 1686202844000,
    image_url:
